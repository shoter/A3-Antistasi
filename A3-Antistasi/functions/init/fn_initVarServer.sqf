...
private _vehTransportHelis = vehNATOTransportHelis + vehCSATTransportHelis;
DECLARE_SERVER_VAR(vehTransportHelis, _vehTransportHelis);
...
private _vehFIA = [vehSDKBike,vehSDKAT,vehSDKLightArmed,SDKMGStatic,vehSDKLightUnarmed,vehSDKTruck,vehSDKBoat,SDKMortar,staticATteamPlayer,staticAAteamPlayer,vehSDKRepair,vehSDKGunship,vehSDKTank];
