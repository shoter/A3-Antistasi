...
if (_tab isEqualTo "vehicles") then 
{
    ...
    private _added = 0;
    {
        ...
        */
        ...
        _button ctrlSetTooltip format [localize "STR_antistasi_dialogs_buy_vehicle_button_tooltip", _displayName, _price, "PLN"];
...
if  (_tab in ["other"]) then
{
    ...
    private _added = 0;
    {
        ...
        */
        ...
        _button ctrlSetPosition [0, 25 * GRID_H, 44 * GRID_W, 12 * GRID_H];
        _button ctrlSetText _displayName;
        _button ctrlSetTooltip format [localize "STR_antistasi_dialogs_buy_item_tooltip", _displayName, _price, "PLN"];
        _button setVariable ["className", _className];
        _button setVariable ["model", _model];
