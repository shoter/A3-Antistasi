    ...
    class Controls
    {
        ...
        class PlayerStatsDetailsTab : A3A_DefaultControlsGroup
        {
            ...
            class controls
            {
                ...
                class DetailsBackground : A3A_Background
                {
                    idc = -1;
                    x = 8 * GRID_W;
                    y = 12 * GRID_H;
                ...
                // Sections, tables and the weapon list are created at runtime by fn_playerStatsTab "detailsReceived";
                // the group scrolls vertically when they do not fit
                class DetailsScroll : A3A_ControlsGroupNoHScrollbars
                {
                    idc = A3A_IDC_PLAYERDETAILS_SCROLL;
                    x = 8 * GRID_W;
                    y = 12 * GRID_H;
                    w = 144 * GRID_W;
                    h = 82 * GRID_H;
                ...
                class DetailsStatusText : A3A_Text
                {
                    idc = A3A_IDC_PLAYERDETAILS_STATUSTEXT;
                    text = "";
                    sizeEx = GUI_TEXT_SIZE_SMALL;
                    x = 8 * GRID_W;
                    y = 95 * GRID_H;
